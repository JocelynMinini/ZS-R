classdef ZS_DENSMO_V < ZS_Super_Continuum
        
    methods
        function self = ZS_DENSMO_V(f)
        %-------------------------------------------------------------------------------
        % Name:           ZS_DENSMO_V
        % Purpose:        Constructor
        ...
        % Densification
        if data(29) == 1
            self.NON_LINEAR.DENSIFICATION.C1     = data(24);
            self.NON_LINEAR.DENSIFICATION.C2     = data(25);
        elseif data(18) == 2
            self.NON_LINEAR.DENSIFICATION.A      = data(25);
            self.NON_LINEAR.DENSIFICATION.B      = data(25);
            self.NON_LINEAR.DENSIFICATION.GAMMA  = data(25);
        end
