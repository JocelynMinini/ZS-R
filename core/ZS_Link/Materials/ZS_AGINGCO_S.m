classdef ZS_AGINGCO_S < ZS_Super_Continuum
        
    methods
        function self = ZS_AGINGCO_S(f)
        %-------------------------------------------------------------------------------
        % Name:           ZS_AGINGCO_S
        % Purpose:        Constructor
        ...
        Shell = ZS_Super_Shell;

        temp = Shell.read_HEAT(f,extra_group_flag);
        self.HEAT = temp.HEAT;
        end
        ...
        temp = Shell.read_HUMID(f,extra_group_flag);
